...
import stockm.config.JwtFilter;
import stockm.config.TokenProvider;
import stockm.dto.LoginDTO;
import stockm.dto.TokenDTO;
...
public class UserController {
	...
	public ResponseEntity<TokenDTO> authorize( HttpServletRequest request, @Validated @RequestBody LoginDTO loginDTO){
	...
	@PostMapping("/signup")
	public ResponseEntity<UserEntity> signup(@Validated @RequestBody UserDTO userDto) {
